...
namespace Protocol
{
    public enum msg_type : byte { REQUEST_PORT = 1, LOOKUP_PORT = 2, KEEP_ALIVE = 3, CLOSE_PORT = 4, RESPONSE = 5, PORT_DEAD = 6, STOP = 7 };
    public enum status : byte { SUCCESS = 0, SERVICE_IN_US = 1, SERVICE_NOT_FOUND = 2, ALL_PORTS_BUSY = 3, INVALID_ARG = 4, UNDEFINED_ERROR = 5 }
